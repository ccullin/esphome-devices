import{E as t,G as e,T as o,H as i,r as s,_ as r,e as a,n,s as l,I as c,J as p,K as d,L as h,l as u,x as m,B as _,C as v,t as g,N as w,y,O as f}from"./index-zaYCB7m6.js";import{g as b}from"./c.BsE5xiOP.js";import"./c.B41VBpbv.js";import{o as $,c as S}from"./c.Ceriyo_r.js";import{m as P,s as x,b as k}from"./c.JensFMpi.js";import{o as C}from"./c.ByTXXitT.js";class E{constructor(t){this.G=t}disconnect(){this.G=void 0}reconnect(t){this.G=t}deref(){return this.G}}class j{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){var t;null!==(t=this.Y)&&void 0!==t||(this.Y=new Promise((t=>this.Z=t)))}resume(){var t;null===(t=this.Z)||void 0===t||t.call(this),this.Y=this.Z=void 0}}const H=t=>!i(t)&&"function"==typeof t.then,W=1073741823;const I=t(class extends e{constructor(){super(...arguments),this._$C_t=W,this._$Cwt=[],this._$Cq=new E(this),this._$CK=new j}render(...t){var e;return null!==(e=t.find((t=>!H(t))))&&void 0!==e?e:o}update(t,e){const i=this._$Cwt;let s=i.length;this._$Cwt=e;const r=this._$Cq,a=this._$CK;this.isConnected||this.disconnected();for(let t=0;t<e.length&&!(t>this._$C_t);t++){const o=e[t];if(!H(o))return this._$C_t=t,o;t<s&&o===i[t]||(this._$C_t=W,s=0,Promise.resolve(o).then((async t=>{for(;a.get();)await a.get();const e=r.deref();if(void 0!==e){const i=e._$Cwt.indexOf(o);i>-1&&i<e._$C_t&&(e._$C_t=i,e.setValue(t))}})))}return o}disconnected(){this._$Cq.disconnect(),this._$CK.pause()}reconnected(){this._$Cq.reconnect(this),this._$CK.resume()}}),D=(t,e)=>{import("./c.D3e4Rk27.js");const o=document.createElement("esphome-compile-dialog");o.configuration=t,o.platformSupportsWebSerial=e,document.body.append(o)},T=async(t,e)=>{import("./c.C9a2zlGT.js");let o=t.port;if(o)await o.close();else try{o=await navigator.serial.requestPort()}catch(o){return void("NotFoundError"===o.name?$((()=>T(t,e))):alert(`Unable to connect: ${o.message}`))}const i=S(o);e&&e();const s=document.createElement("esphome-install-web-dialog");s.params=t,s.esploader=i,document.body.append(s)},B={info:h,warning:d,error:p,success:c};let A=class extends l{constructor(){super(...arguments),this.title="",this.alertType="info",this.rtl=!1}render(){return m`
      <div
  ...
  `,r([a()],A.prototype,"title",void 0),r([a({attribute:"alert-type"})],A.prototype,"alertType",void 0),r([a({type:Boolean})],A.prototype,"rtl",void 0),A=r([n("esphome-alert")],A);const q=(t,e)=>{import("./c.DymbnHEA.js");const o=document.createElement("esphome-download-type-dialog");o.configuration=t,o.platformSupportsWebSerial=e,document.body.append(o)};let U=class extends l{constructor(){super(...arguments),this._ethernet=!1,this._isPico=!1,this._shouldDownloadFactory=!1,this._state="pick_option"}get _platformSupportsWebSerial(){return!this._isPico}render(){let t,e;if("pick_option"===this._state)t=`How do you want to install ${this.configuration} on your device?`,e=m`
        <mwc-list-item
          twoline
          hasMeta
          .port=${"OTA"}
      ...
      `;else if("pick_server_port"===this._state)t="Pick Server Port",e=void 0===this._ports?this._renderProgress("Loading serial devices"):m`
              ...
              ></mwc-button>
            `;else if("download_instructions"===this._state){let o;const i=I(this._compileConfiguration,m`<a download disabled href="#">Download project</a>
          preparing&nbsp;download…
    ...
    `],r([a()],U.prototype,"configuration",void 0),r([g()],U.prototype,"_ethernet",void 0),r([g()],U.prototype,"_isPico",void 0),r([g()],U.prototype,"_shouldDownloadFactory",void 0),r([g()],U.prototype,"_ports",void 0),r([g()],U.prototype,"_state",void 0),r([g()],U.prototype,"_error",void 0),U=r([n("esphome-install-choose-dialog")],U);var O=Object.freeze({__proto__:null});export{D as a,T as b,O as i,q as o};
//# sourceMappingURL=c.pzUM4vYj.js.map
