...
optional<uint32_t> LightSleepComponent::get_run_duration_() const {
...
void LightSleepComponent::set_ext1_wakeup(Ext1Wakeup ext1_wakeup) { this->ext1_wakeup_ = ext1_wakeup; }

#if !defined(USE_ESP32_VARIANT_ESP32H2)
void LightSleepComponent::set_touch_wakeup(bool touch_wakeup) { this->touch_wakeup_ = touch_wakeup; }
#endif
...
void LightSleepComponent::dump_config_platform_() {
...
void LightSleepComponent::light_sleep_() {
  ...
  if (this->wakeup_pin_ != nullptr) {
    ...
    esp_light_sleep_enable_gpio_wakeup(1 << this->wakeup_pin_->get_pin(),
                                      static_cast<esp_lightsleep_gpio_wake_up_mode_t>(level));
  }
#endif
